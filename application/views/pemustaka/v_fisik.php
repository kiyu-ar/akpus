...
<div>
    <div>
        <div>
            <h4 style="float: left;">Kunjungan per Prodi per Bulan</h4>
            <a id="export-kunjungan-prodi" style="float: right;" class="btn btn-primary" href="#" target="_blank">Export Excel</a>
        </div>
    ...
    <div>
        <div>
            <h4 style="float: left;">Total Kunjungan per Bulan</h4>
        ...
        <p style="clear: both;">Jumlah Total Kunjungan Pemustaka per Bulan</p>
        <iframe class="jframe" src="<?php echo base_url() ?>pemustaka/kunjungan_total" frameborder="0"></iframe>
    </div>
</div>