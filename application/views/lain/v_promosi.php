...
<div class="modal fade" id="tambahjenis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h3 class="modal-title" id="exampleModalLabel"><b>Tambah Jenis Promosi</b> </h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <form method="post" action="<?php echo base_url().'lain/tambah_jenis_promosi'?>" enctype="multipart/form-data">
        <div class="form-group">
            <label>Nama Jenis Promosi</label>
            <input type="text" name="jenis_promosi" class="form-control" placeholder="Nama Jenis Promosi">
        </div>
